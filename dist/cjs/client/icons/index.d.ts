 ...
 * ```
 */
export type { IconCategory, IconProps, IconComponent, IconDefinition, IconRegistry, IconName, PartialIconRegistry } from './types.js';
export { getIconRegistry, getIcon, getIconData, setIcon, registerIcons, resetIcons, getIconsByCategory, getMeasureTypeIcon, getChartTypeIcon, getFieldTypeIcon } from './registry.js';
