...
var e = "[A-Za-z$_][0-9A-Za-z$_]*", t = /* @__PURE__ */ "as.in.of.if.for.while.finally.var.new.function.do.return.void.else.break.catch.instanceof.with.throw.case.default.try.switch.continue.typeof.delete.let.yield.const.class.debugger.async.await.static.import.from.export.extends.using".split("."), n = [
	"true",
	"false",
	"null",
	"undefined",
	...
	return {
		...
		contains: [
			...
			{ beginKeywords: "while if switch catch for" },
			{
				...
				returnBegin: !0,
				label: "func.def",
				contains: [k, c.inherit(c.TITLE_MODE, {
					begin: d,
					className: "title.function"
				})]
			},
...
//# sourceMappingURL=javascript-D6aJaG8F.js.map