...
import { CubeQuery, Filter, ChartType, ChartAxisConfig, ChartDisplayConfig, MultiQueryConfig, QueryMergeStrategy, FunnelBindingKey, AnalysisType, FunnelStepState } from '../../types.js';
import { ColorPalette } from '../../utils/colorPalettes.js';
import { MetaResponse, MetaField, MetaCube, QueryAnalysis } from '../../shared/types.js';
...
export declare const TIME_GRANULARITIES: readonly [{
    readonly value: "hour";
    readonly label: "timeGranularity.hour";
}, {
    readonly value: "day";
    readonly label: "timeGranularity.day";
}, {
    readonly value: "week";
    readonly label: "timeGranularity.week";
}, {
    readonly value: "month";
    readonly label: "timeGranularity.month";
}, {
    readonly value: "quarter";
    readonly label: "timeGranularity.quarter";
}, {
    readonly value: "year";
    readonly label: "timeGranularity.year";
}];
