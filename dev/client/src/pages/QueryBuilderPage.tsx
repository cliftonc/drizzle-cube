...
export default function QueryBuilderPage() {
  return (
    <div className="-m-6 min-h-screen flex flex-col">
      {/* Header */}
      <div className="shrink-0 border-b border-white/20 dark:border-gray-700 px-4 sm:px-6 py-4">
        ...
        <div className="mt-4 px-4 py-3 bg-linear-to-br from-purple-50 via-violet-50 to-pink-50 dark:from-purple-900/20 dark:via-violet-900/20 dark:to-pink-900/20 border border-purple-200/50 dark:border-purple-800/50 rounded-lg shadow-md shadow-purple-100/50 dark:shadow-purple-900/20">
