  ...
  if (isLoading) {
    return (
      <div className="text-center py-8">
        ...
        <p className="mt-2 text-gray-600 dark:text-gray-400">Loading dashboards...</p>
      </div>
    )
  }
        ...
        <div className="mt-4 flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-2">
            <button
              ...
              className="inline-flex items-center justify-center rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-200 shadow-2xs hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-hidden focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900 disabled:opacity-50 w-full sm:w-auto"
            >
            ...
            <button
              ...
              className="inline-flex items-center justify-center rounded-md border border-transparent bg-blue-600 dark:bg-blue-500 px-4 py-2 text-sm font-medium text-white shadow-2xs hover:bg-blue-700 dark:hover:bg-blue-600 focus:outline-hidden focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900 disabled:opacity-50 w-full sm:w-auto"
            >
              New Dashboard
            </button>
          </div>
          ...
          {pages.length >= 10 && (
            <div className="px-3 py-2 bg-linear-to-r from-amber-50 to-yellow-50 dark:from-amber-900/30 dark:to-yellow-900/30 border border-amber-200 dark:border-amber-800 rounded-lg">
      ...
      {pages.length === 0 ? (
        <div className="text-center py-8 sm:py-12 px-4">
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-center max-w-xs mx-auto sm:max-w-none">
            <button
              onClick={handleCreateExample}
              disabled={createExample.isPending || pages.length >= 10}
              className="inline-flex items-center justify-center rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-200 shadow-2xs hover:bg-gray-50 dark:hover:bg-gray-700 disabled:opacity-50 w-full sm:w-auto"
            >
            ...
            <button
              onClick={() => setIsNewModalOpen(true)}
              disabled={pages.length >= 10}
              className="inline-flex items-center justify-center rounded-md border border-transparent bg-blue-600 dark:bg-blue-500 px-4 py-2 text-sm font-medium text-white shadow-2xs hover:bg-blue-700 dark:hover:bg-blue-600 disabled:opacity-50 w-full sm:w-auto"
            >
        ...
        <div className="grid grid-cols-1 gap-4 sm:gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {pages.map((page) => (
            <div
              key={page.id}
              className="relative group bg-white dark:bg-gray-800 rounded-lg shadow-2xs hover:shadow-md transition-shadow touch-manipulation border dark:border-gray-700"
            >
              <div className="p-4 sm:p-6">
                ...
                <div>
                  <Link
                    ...
                    className="block w-full text-center bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 hover:bg-blue-100 dark:hover:bg-blue-900/50 px-3 py-2.5 sm:py-2 rounded-md text-sm font-medium transition-colors touch-manipulation"
                  >
                    View Dashboard
                  </Link>
                </div>
