...
export const candlestickChartConfig: ChartTypeConfig = {
  ...
  displayOptionsConfig: [
    ...
    {
      key: 'openField',
      label: 'Open Field (optional override)',
      type: 'string',
      placeholder: 'e.g. Quotes.open',
      description: 'Explicit field name for open price (overrides yAxis[0])',
    },
    {
      key: 'closeField',
      label: 'Close Field (optional override)',
      type: 'string',
      placeholder: 'e.g. Quotes.close',
      description: 'Explicit field name for close price (overrides yAxis[1])',
    },
    {
      key: 'highField',
      label: 'High Field (optional override)',
      type: 'string',
      placeholder: 'e.g. Quotes.high',
      description: 'Explicit field name for high price (overrides yAxis[2])',
    },
    {
      key: 'lowField',
      label: 'Low Field (optional override)',
      type: 'string',
      placeholder: 'e.g. Quotes.low',
      description: 'Explicit field name for low price (overrides yAxis[3])',
    },
    {
      key: 'bullColor',
