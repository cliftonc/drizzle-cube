  ...
  try {
      ...
      return (
        <div className="dc:flex dc:items-center dc:justify-center dc:w-full text-dc-text-muted" style={{ height }}>
          <div className="dc:text-center">
            ...
            <div className="dc:text-xs text-dc-text-secondary">No data points to display in donut chart</div>
          </div>
        </div>
      )
    }
      ...
      return (
        <div className="dc:flex dc:items-center dc:justify-center dc:w-full text-dc-warning" style={{ height }}>
          <div className="dc:text-center">
            ...
            <div className="dc:text-xs">chartConfig.x/y or chartConfig.xAxis/yAxis required for donut chart</div>
          </div>
        </div>
      )
    }
          ...
          <div className="dc:text-center">
            ...
            <div className="dc:text-xs text-dc-text-secondary">
              {originalLength > 0
                ...
                : 'No data points to display in donut chart'
              }
            </div>
          </div>
        </div>
    ...
    return (
      <div className="dc:flex dc:flex-col dc:items-center dc:justify-center dc:w-full text-dc-error dc:p-4" style={{ height }}>
        <div className="dc:text-center">
          <div className="dc:text-sm dc:font-semibold dc:mb-1">Donut Chart Error</div>
