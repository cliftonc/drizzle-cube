...
const ConfirmModal: React.FC<ConfirmModalProps> = ({
  ...
  const getConfirmButtonClasses = () => {
    ...
    switch (confirmVariant) {
      case 'danger':
        return `${baseClasses} bg-dc-danger text-white hover:bg-dc-danger/90 focus:ring-dc-danger`
      case 'warning':
        return `${baseClasses} bg-dc-warning text-white hover:bg-dc-warning/90 focus:ring-dc-warning`
      case 'primary':
      default:
        return `${baseClasses} bg-dc-primary text-white hover:bg-dc-primary/90 focus:ring-dc-primary`
    }
  }
