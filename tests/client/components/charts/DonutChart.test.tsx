 ...
 *
 * DonutChart is identical to PieChart except for innerRadius="40%"
 * which creates the hollow center distinguishing it from a pie chart.
 */
...
// Sample test data for donut chart
const mockDonutData = [
  {
...
describe('DonutChart', () => {
  ...
  describe('basic rendering', () => {
    it('should render donut chart with valid data and config', () => {
      const { container } = render(
        <DonutChart data={mockDonutData} chartConfig={basicChartConfig} />
      )

      // DonutChart renders via Recharts which uses SVG
    ...
    it('should support legacy chart config format', () => {
      const { container } = render(
        <DonutChart data={mockDonutData} chartConfig={legacyChartConfig} />
      )
  ...
  describe('empty data handling', () => {
    it('should show "No data available" when data is null', () => {
      ...
      expect(
        screen.getByText('No data points to display in donut chart')
      ).toBeInTheDocument()
    })
    ...
    it('should show "No data available" when data array is empty', () => {
      render(<DonutChart data={[]} chartConfig={basicChartConfig} />)
    ...
    it('should show "No valid data" when all values are zero', () => {
      ...
      render(<DonutChart data={zeroData} chartConfig={basicChartConfig} />)
    ...
    it('should show "No valid data" when all values are negative', () => {
      ...
      render(<DonutChart data={negativeData} chartConfig={basicChartConfig} />)
  ...
  describe('configuration errors', () => {
    it('should show configuration error when chartConfig is missing', () => {
      render(<DonutChart data={mockDonutData} />)
  ...
  describe('boolean value handling', () => {
    it('should convert boolean true/false to Active/Inactive labels', () => {
      ...
      const { container } = render(
        <DonutChart data={mockBooleanData} chartConfig={boolConfig} />
      )
    ...
    it('should handle string "true"/"false" values', () => {
      ...
      const { container } = render(
        <DonutChart data={stringBoolData} chartConfig={boolConfig} />
      )
  ...
  describe('edge cases', () => {
    it('should handle single data point', () => {
      ...
      const { container } = render(
        <DonutChart data={singlePoint} chartConfig={basicChartConfig} />
      )
    ...
    it('should handle very large numbers', () => {
      ...
      const { container } = render(
        <DonutChart data={largeNumbers} chartConfig={basicChartConfig} />
      )
    ...
    it('should filter out zero values', () => {
      ...
      const { container } = render(
        <DonutChart data={mixedData} chartConfig={basicChartConfig} />
      )
    ...
    it('should handle NaN values', () => {
      ...
      const { container } = render(
        <DonutChart data={nanData} chartConfig={basicChartConfig} />
      )
    ...
    it('should handle decimal values', () => {
      ...
      const { container } = render(
        <DonutChart data={decimalData} chartConfig={basicChartConfig} />
      )
    ...
    it('should handle string numeric values', () => {
      ...
      const { container } = render(
        <DonutChart data={stringData} chartConfig={basicChartConfig} />
      )
    ...
    it('should handle Unknown category name', () => {
      ...
      const { container } = render(
        <DonutChart data={unknownData} chartConfig={basicChartConfig} />
      )
