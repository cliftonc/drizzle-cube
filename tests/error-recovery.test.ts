...
describe('Error Recovery Tests', () => {
  ...
  describe('Invalid Limit/Offset', () => {
    ...
    // DuckDB/Databend/Snowflake: Number.MAX_SAFE_INTEGER causes integer overflow in LIMIT
    it.skipIf(skipIfDuckDB() || skipIfDatabend() || skipIfSnowflake())('should handle very large limit', async () => {
      const query: SemanticQuery = {
        measures: ['Employees.count'],
        dimensions: ['Employees.name'],
