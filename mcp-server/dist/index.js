...
const tools = [
    {
        ...
        description: 'Fetch cube metadata including measures, dimensions, and relationships from the Drizzle Cube API',
        inputSchema: {
            type: 'object',
            properties: {},
            required: [],
    ...
    },
    {
        ...
        description: 'Validate a query and preview the generated SQL without executing it',
        inputSchema: {
            type: 'object',
            properties: {
                query: {
                    ...
                    properties: {
                        measures: {
                            type: 'array',
                            items: { type: 'string' },
                            description: 'Array of measure names (e.g., ["Sales.totalRevenue"])',
                        },
                        dimensions: {
                            type: 'array',
                            items: { type: 'string' },
                            description: 'Array of dimension names (e.g., ["Products.category"])',
                        },
                        timeDimensions: {
                            type: 'array',
                            items: {
                        ...
                        order: {
                            type: 'object',
                            description: 'Order configuration (e.g., {"Sales.revenue": "desc"})',
                        },
                        limit: {
                            type: 'number',
        ...
        switch (name) {
            ...
            case 'drizzle_cube_config': {
                ...
                const status = {
                    ...
                    help: {
                        setup: 'Run /drizzle-cube setup to configure interactively',
